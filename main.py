...
if __name__ == "__main__":
    ...
    engine = create_engine(sink, GameDesignQuickStart, human_player_name = None, number_of_players=5, generic_players=False, allow_rename=False, api_client=api_client)
    engine.run() 
