...
class GameEventSink(ABC):
    ...
    @abstractmethod
    def on_public_action(self, speaker: Speaker, message: str, color: str = "", animate_as_player: bool = True, should_hold: bool = True, directed_to_name=None, is_reply: bool = False) -> None:
        """
        ...
        frontend should word-by-word animate this message like a player (True for players
        and generated host lines; False for scripted host → HostStagger, and SYSTEM/humans).
...
class NoopGameSink(GameEventSink):
    ...
    def on_public_action(self, speaker, message, color="", animate_as_player=True, should_hold=True, directed_to_name=None, is_reply=False): pass
...
class CapturingGameSink(GameEventSink):
    ...
    def on_public_action(self, speaker, message, color="", animate_as_player=True, should_hold=True, directed_to_name=None, is_reply=False):
        if directed_to_name:
