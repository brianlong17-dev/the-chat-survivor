...
FIXTURES = [
    FixtureEntry(
        ...
        pd_desc="'True friends, huh? That's what you say when you want someone to go easy on you.'\n This is a CLASSIC best friends finale- only one is ready to steal.  ",
    ...
    FixtureEntry(
        ...
        reunion_desc=("""At this point all the agent models correctly see through Quirrell, but a jury of villains basically respect him for it.
                   """),
        finale=True,
    ),
